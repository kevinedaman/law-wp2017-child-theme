...
<form role="search" method="get" class="form-inline" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<input type="search" id="<?php echo $unique_id; ?>" class="form-control mb-2 mr-sm-2 mb-sm-0" placeholder="<?php echo esc_attr_x( 'Search &hellip;', 'placeholder', 'twentyseventeen' ); ?>" value="<?php echo get_search_query(); ?>" name="s"></input>
